...
/*   Updated: 2023/08/11 15:30:37 by iganiev          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//         philo->meal_count++;
//         if (philo->info->count_meals > 0 && philo->meal_count >= philo->info->count_meals)
// 		{
//             log_die(philo);
//             release_forks(philo);
//             return (NULL);
...
//     while (!info->dead)
//     {
//         if ((info->count_meals != 0) && (philo->meal_count * info->count_philo >= info->count_meals))
//         {
//             info->dead = 1;
//             break;
//         }
